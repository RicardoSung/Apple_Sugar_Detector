...
public class ChartUtil {
    ...
    public static void showChart(Context context, LineChart lineChart, List<String> xDataList,
        ...
        // 标题字体颜色
        description.setTextColor(context.getApplicationContext().getResources().getColor(R.color.txt_black_light));
        //lineChart.setDescriptionColor(context.getApplicationContext().getResources().getColor(R.color.txt_black));
    ...
    private static LineData setLineData(Context context, List<String> xDataList, List<Entry> yDataList,
        ...
        LineData lineData = new LineData((ILineDataSet) xDataList,(ILineDataSet) lineDataSets);
        return lineData;
    }
